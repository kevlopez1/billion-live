...
// Genera una tarjeta 9:16 (story) editorial con la foto real del auto.
// Todo en el navegador. Las imágenes son del mismo origen → el canvas no se
// "ensucia" y se puede exportar. Sin URL en la imagen (pedido del usuario).
export function ShareCard() {
  ...
  const generate = async () => {
    ...
    try {
      ...
      // Marco editorial (línea fina por dentro)
