        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center glass-card p-1 rounded-lg">
            <button
              ...
              className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm transition-colors ${viewMode === "mindmap" ? "btn-accent" : "text-muted-foreground hover:text-foreground"
                }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm transition-colors ${viewMode === "grid" ? "btn-accent" : "text-muted-foreground hover:text-foreground"
                }`}
            >
          ...
          {isAdmin && (
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2 btn-accent rounded-lg transition-colors text-sm font-medium"
            >
