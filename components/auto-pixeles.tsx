...
export function AutoPixeles() {
  ...
  const enviar = async (e: React.FormEvent) => {
    ...
    if (!name.trim()) return toast.error("Pon tu nombre o el de tu marca.")
    setEnviando(true)
    try {
      ...
      toast.error("Falló la conexión. Inténtalo de nuevo.")
    } finally {
      setEnviando(false)
    }
  }
  ...
  return (
    <div>
      {/* ── El auto ──
          ...
          en vez del vector, se cambia aquí adentro y las zonas, los precios y la
