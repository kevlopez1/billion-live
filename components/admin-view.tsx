        ...
        {activeTab === "metrics" && (
          <div className="space-y-6">
            ...
            <button
              ...
              disabled={isLoading}
              className="flex items-center gap-2 px-6 py-3 btn-accent rounded-xl transition-colors disabled:opacity-50"
            >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="flex items-center gap-2 px-4 py-2 btn-accent rounded-lg text-sm transition-colors disabled:opacity-50"
                >
